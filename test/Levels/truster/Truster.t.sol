...
import {FlashLoanAttack} from "../../../src/Contracts/truster/FlashLoanAttack.sol";
...
contract Truster is Test {
    ...
    function testExploit() public {
        ...
        flashLoanAttack = new FlashLoanAttack();
        flashLoanAttack.attack(address(trusterLenderPool), address(dvt));
        vm.stopPrank();
